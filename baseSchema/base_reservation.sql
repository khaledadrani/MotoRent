...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `matricule` FOREIGN KEY (`matricule`) REFERENCES `vehicule` (`matricule`) ON DELETE CASCADE
...
INSERT INTO `reservation` VALUES (12,17,'140tun1874','2018-12-25','2018-12-30','2018-12-30',700,'450');
